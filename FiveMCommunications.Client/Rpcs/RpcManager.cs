namespace FiveMCommunications.Client.Rpc
{
    ...
    {
		private static readonly ILogger Logger = new FiveMCommunicationsLogger("RPC");
		...
		{
			if (message.Event != CommunicationEvents.LogMirror) Logger.Trace(message.Payloads.Count > 0
